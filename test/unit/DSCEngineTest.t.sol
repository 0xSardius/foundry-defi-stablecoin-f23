...
contract DSCEngineTest is Test {
    ...
    function testRevertsIfMintedDscBreaksHealthFactor() public {
        (, int256,,,) = MockV3Aggregator(ethUsdPriceFeed).latestRoundData();
        amountToMint = (amountCollateral * (uint256(price) * dsce.getAdditionalFeedPrecision())) / dsce.getFeedPrecision();
        vm.startPrank(user);
